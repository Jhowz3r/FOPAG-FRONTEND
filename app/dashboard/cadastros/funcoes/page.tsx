  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <Link href="/dashboard/cadastros/funcoes/new">
          <Button>
            ...
            {funcoes.length === 0 ? (
              ...
              funcoes.map((funcao) => (
                <tr key={funcao.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    {funcao.pisoSalarial
                      ? `R$ ${funcao.pisoSalarial.toFixed(2).replace(".", ",")}`
                      : "-"}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    {funcao.tetoSalarial
                      ? `R$ ${funcao.tetoSalarial.toFixed(2).replace(".", ",")}`
                      : "-"}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <div className="flex items-center justify-end gap-2">
                      <button
                        onClick={() =>
                          router.push(`/dashboard/cadastros/funcoes/edit/${funcao.id}`)
                        }
