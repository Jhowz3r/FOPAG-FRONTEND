...
export default function EditFuncionarioPage() {
  ...
  useEffect(() => {
    loadEmpresas();
    if (funcionarioId) {
      loadFuncionario(Number(funcionarioId));
    }
  }, [funcionarioId]);
  ...
  const toDateStr = (dateVal: string | Date | undefined) => {
    if (!dateVal) return undefined;
    return new Date(dateVal).toISOString().split('T')[0];
  };

  const loadFuncionario = async (id: number) => {
    try {
      setLoading(true);
      ...
      reset({
        ...func,
        // Datas
        dataAdmissao: toDateStr(func.dataAdmissao),
        dataOpcaoFGTS: toDateStr(func.dataOpcaoFGTS),
        dataNascimento: toDateStr(func.dataNascimento),
        carteiraDataExped: toDateStr(func.carteiraDataExped),
        dataVecToContrExp: toDateStr(func.dataVecToContrExp),
        dataAvisoPrevio: toDateStr(func.dataAvisoPrevio),
        dataAquisicaoFerias: toDateStr(func.dataAquisicaoFerias),
        dataEntradaTransferencia: toDateStr(func.dataEntradaTransferencia),
        dataSaidaTransferencia: toDateStr(func.dataSaidaTransferencia),
        dataExpedicaoIdentidade: toDateStr(func.dataExpedicaoIdentidade),
        habilitacaoValidade: toDateStr(func.habilitacaoValidade),
        vencimentoExameMedico: toDateStr(func.vencimentoExameMedico),
        dataEstabilidade: toDateStr(func.dataEstabilidade),

        // Campos Opcionais undefined
        idNacionalidade: func.idNacionalidade || undefined,
        idGps: func.idGps || undefined,
        idExposicaoAgenteNocivo: func.idExposicaoAgenteNocivo || undefined,
        idCategoria: func.idCategoria || undefined,
        idAgencia: func.idAgencia || undefined,
        idMunicipio: func.idMunicipio || undefined,
        cpf: func.cpf || undefined,
        pis: func.pis || undefined,
        tipoSalario: func.tipoSalario || undefined,
        carteiraNumero: func.carteiraNumero || undefined,
        carteiraEstado: func.carteiraEstado || undefined,
        carteiraSerie: func.carteiraSerie || undefined,
        contaCorrenteOperacao: func.contaCorrenteOperacao || undefined,
        contaCorrenteNumero: func.contaCorrenteNumero || undefined,
        contaCorrenteDigito: func.contaCorrenteDigito || undefined,
        contaFGTS: func.contaFGTS || undefined,
        digitoContaFGTS: func.digitoContaFGTS || undefined,
        percentualAdiantamento: func.percentualAdiantamento || undefined,
        cep: func.cep || undefined,
        ddd: func.ddd || undefined,
        telefone: func.telefone || undefined,
        identidade: func.identidade || undefined,
        ufIdentidade: func.ufIdentidade || undefined,
        observacao: func.observacao || undefined,

        // Novos campos opcionais
        idFuncao: func.idFuncao || undefined,
        idHorario: func.idHorario || undefined,
        tipoContrato: func.tipoContrato || undefined,
        tipoPagamento: func.tipoPagamento || undefined,
        denominacaoCep: func.denominacaoCep || undefined,
        bairroCep: func.bairroCep || undefined,
        localidadeCep: func.localidadeCep || undefined,
        ufCep: func.ufCep || undefined,
        complementoCep: func.complementoCep || undefined,
        numeroCep: func.numeroCep || undefined,
        orgaoExpedidorIdentidade: func.orgaoExpedidorIdentidade || undefined,
        tituloEleitor: func.tituloEleitor || undefined,
        tituloEleitorSecao: func.tituloEleitorSecao || undefined,
        tituloEleitorZona: func.tituloEleitorZona || undefined,
        carteiraReservista: func.carteiraReservista || undefined,
        habilitacaoNumero: func.habilitacaoNumero || undefined,
        habilitacaoCategoria: func.habilitacaoCategoria || undefined,
        matriculaINSS: func.matriculaINSS || undefined,
        registroLivro: func.registroLivro || undefined,
        naturalidade: func.naturalidade || undefined,
        estadoNaturalidade: func.estadoNaturalidade || undefined,
        naturalizacao: func.naturalizacao || undefined,
        naturalizacaoAnoChegada: func.naturalizacaoAnoChegada || undefined,
        nomeConjuge: func.nomeConjuge || undefined,
        nomePai: func.nomePai || undefined,
        nomeMae: func.nomeMae || undefined,
        complementoFuncao: func.complementoFuncao || undefined,
      });
    } catch (error: any) {
  ...
  const onSubmit = async (data: FuncionarioFormData) => {
    try {
      ...
      await api.patch(`/funcionarios/${funcionarioId}`, payload);
